...
function VideoHero() {
  ...
  return (
    <div className="relative min-h-screen bg-black overflow-hidden flex flex-col font-sans">
      ...
      >
        <div className="rounded-full px-6 py-3 flex items-center justify-between max-w-5xl mx-auto">
          ...
          <div className="hidden md:flex items-center gap-8">
            {['Products', 'Solutions', 'Services', 'Partners', 'Testimonials'].map((link) => (
              <motion.a 
                key={link}
                variants={fadeInUp}
                href="#" 
                className="text-white/80 hover:text-white transition-colors text-[15px] font-[500] tracking-[-0.01em]"
              >
                {link}
              </motion.a>
            ))}
      ...
      >
        {[
          { label: 'Instagram', icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect width="20" height="20" x="2" y="2" rx="5" ry="5"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/><line x1="17.5" x2="17.51" y1="6.5" y2="6.5"/></svg> },
          { label: 'Twitter', icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M22 4s-.7 2.1-2 3.4c1.6 10-9.4 17.3-18 11.6 2.2.1 4.4-.6 6-2C3 15.5.5 9.6 3 5c2.2 2.6 5.6 4.1 9 4-.9-4.2 4-6.6 7-3.8 1.1 0 3-1.2 3-1.2z"/></svg> },
          ...
          <motion.button 
            ...
            className="liquid-glass rounded-full p-4 text-white/80 hover:text-white transition-all"
          >
            {item.icon}
          </motion.button>
        ))}
...
{/* Dashboard Mockup - Coded Version matching the image */}
        ...
        <motion.section 
          ...
          viewport={{ once: true }}
          variants={staggerContainer}
          className="py-16 bg-[#FDFBF7]"
        >
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <motion.p variants={fadeInUp} className="text-xl font-serif text-[#2D1600] mb-12">
              Trusted by leading enterprises across 15+ countries
            </motion.p>
            <motion.div variants={fadeInUp} className="flex flex-wrap justify-center items-center gap-12 md:gap-20 opacity-80">
              {['SAP', 'AWS', 'Microsoft', 'Oracle Cloud', 'PeopleSoft'].map((logo) => (
                <motion.div 
                  key={logo}
                  whileHover={{ scale: 1.1, opacity: 1 }}
                  className="flex items-center gap-2 font-bold text-xl text-[#2D1600] cursor-default transition-all"
                >
                  {logo}
                </motion.div>
              ))}
        ...
        <section className="bg-[#FDFBF7] pt-24 pb-12">
          ...
          >
            ...
            <motion.h2 variants={fadeInUp} className="text-[2.75rem] md:text-[3.5rem] lg:text-[4rem] font-serif font-semibold text-[#3E1C00] mb-8 tracking-[-0.02em] leading-[1.0]">
              Designed to automate<br/>enterprise operations
            </motion.h2>
            <motion.p variants={fadeInUp} className="text-[15px] text-[#A68B7C] max-w-lg mx-auto leading-relaxed">
          ...
          <div className="w-full">
            <motion.div 
              ...
              viewport={{ once: true }}
              variants={staggerContainer}
              className="max-w-[1400px] mx-auto border-y border-[#EAE0D5] grid grid-cols-1 md:grid-cols-3"
            >
              {/* Card 1 */}
              <motion.div variants={fadeInUp} className="p-8 lg:p-10 border-b border-[#EAE0D5] md:border-r bg-[#FDFBF7] flex flex-col items-center">
                <motion.div 
                  whileHover={{ y: -5, boxShadow: "0 20px 40px rgba(0,0,0,0.05)" }}
                  className="bg-white rounded-2xl shadow-[0_8px_30px_-4px_rgba(0,0,0,0.05)] w-full max-w-[480px] p-8 lg:p-10 border border-[#EAE0D5]/50 flex flex-col flex-1 transition-shadow"
                >
                  ...
                  <div className="flex items-baseline gap-3 mb-2">
                    <span className="text-[2.5rem] font-bold text-[#3E1C00] tracking-tight">
                      <Counter value="335,453" />
                    </span>
                  </div>
                  ...
                  <ul className="space-y-4 mt-auto text-[12px] text-[#3E1C00] font-bold w-full bg-[#FDFBF7] p-5 rounded-xl border border-[#EAE0D5]/50">
                    {[
                      ...
                      <motion.li 
                        ...
                        className="flex gap-3 items-center leading-tight"
                      >
                ...
                >
                  ...
                  <div className="text-center mb-6 mt-2">
                    ...
                    <div className="text-[3.75rem] font-[700] flex items-baseline justify-center leading-none tracking-[-0.03em]">
                      <span className="text-[#3E1C00]">₹<Counter value="508" />.00</span>
                    </div>
                  </div>
                  ...
                  <div className="flex items-end justify-between gap-2 h-16 mt-auto">
                    {[16, 24, 18, 28, 12, 16, 35, 18, 12, 30, 20, 26].map((h, i) => (
                      <motion.div 
                        ...
                        key={i} 
                        className={`flex-1 rounded-sm ${i === 6 ? 'bg-[#A68B7C]' : 'bg-[#EAE0D5]'}`} 
                      />
                    ))}
                  </div>
                </motion.div>
              ...
              {/* Card 3 */}
              <motion.div variants={fadeInUp} className="p-8 lg:p-10 border-b border-[#EAE0D5] bg-[#FDFBF7] flex flex-col items-center">
                <motion.div 
                  whileHover={{ y: -5, boxShadow: "0 20px 40px rgba(0,0,0,0.05)" }}
                  className="bg-white rounded-2xl shadow-[0_8px_30px_-4px_rgba(0,0,0,0.05)] w-full max-w-[480px] p-8 lg:p-10 border border-[#EAE0D5]/50 flex flex-col flex-1 transition-shadow"
                >
                  ...
                  <div className="relative w-full aspect-[2/1] overflow-hidden mb-6 mt-8 flex justify-center">
                    ...
                    <div className="absolute bottom-0 left-0 right-0 text-center flex flex-col items-center">
                      <div className="text-[2rem] font-bold text-[#3E1C00] leading-none mb-1">
                        <Counter value="78.9%" />
                      </div>
        ...
        <section className="bg-[#FDFBF7] pt-24 pb-24">
          ...
          <div className="w-full">
            <motion.div 
              ...
              viewport={{ once: true }}
              variants={staggerContainer}
              className="max-w-[1400px] mx-auto border-y border-[#EAE0D5] flex flex-col"
            >
              
              {/* Row 1: Support */}
              <motion.div variants={fadeInUp} className="grid grid-cols-1 md:grid-cols-2">
                ...
                <div className="bg-[#FAF8F3] p-14 lg:p-20 flex items-center justify-center">
                  <motion.div 
                    whileHover={{ y: -5, boxShadow: "0 20px 40px rgba(0,0,0,0.05)" }}
                    className="bg-white rounded-2xl shadow-[0_8px_30px_-4px_rgba(0,0,0,0.05)] w-full max-w-[520px] p-10 border border-[#EAE0D5]/50 flex flex-col transition-shadow"
                  >
                    <div className="flex justify-between items-center mb-6">
                    ...
                    <div className="flex flex-col gap-4">
                      {[
                        { label: 'Office Supplies Contract', status: 'Approved', color: 'emerald' },
                        { label: 'Q2 Hardware Procurement', status: 'In Review', color: 'amber' },
                        { label: 'Logistics RFQ', status: 'Negotiating', color: 'blue' },
                        { label: 'Annual Software Licenses', status: 'Executed', color: 'stone' },
                      ].map((item, idx) => (
                        <motion.div 
                          key={idx}
                          initial={{ opacity: 0, x: -10 }}
                          whileInView={{ opacity: 1, x: 0 }}
                          transition={{ delay: 0.1 * idx }}
                          className={`flex items-center justify-between ${idx !== 3 ? 'border-b border-[#EAE0D5] pb-3' : 'pb-1'}`}
                        >
                          <span className="text-[12px] text-stone-500 font-medium">{item.label}</span>
                          <span className={`text-[10px] font-bold px-2 py-1 bg-${item.color}-50 text-${item.color}-600 rounded`}>{item.status}</span>
                        </motion.div>
                      ))}
                    </div>
                  </motion.div>
              ...
              {/* Row 2: Geography */}
              <motion.div variants={fadeInUp} className="grid grid-cols-1 md:grid-cols-2 border-t border-[#EAE0D5]">
                <div className="bg-white p-14 lg:p-20 border-b md:border-b-0 md:border-r border-[#EAE0D5] flex flex-col justify-center">
                  <div className="flex items-center gap-2 mb-6">
                    <div className="w-3 h-3 bg-[#FF5C00] rounded-[1px]" />
                ...
                <div className="bg-[#FAF8F3] p-14 lg:p-20 flex items-center justify-center">
                  ...
                  >
                    ...
                    <div className="flex items-baseline gap-2 mb-8 mt-4">
                      <span className="text-[2.5rem] font-bold text-[#3E1C00] leading-none">
                        <Counter value="4.9" />/5
                      </span>
                    ...
                    <div className="grid grid-cols-[repeat(15,minmax(0,1fr))] gap-2 w-full mb-2">
                      {[...Array(60)].map((_, i) => (
                        <motion.div 
                          ...
                          className={`w-full aspect-square rounded-full ${i >= 56 ? 'bg-[#EAE0D5]' : 'bg-[#FF5C00]'}`} 
                        />
                      ))}
                    </div>
                  </motion.div>
...
{/* Metrics Section */}
        <section className="bg-[#FDFBF7] pt-24 pb-24 border-t border-[#EAE0D5]">
          ...
          >
            ...
            <motion.p variants={fadeInUp} className="text-[15px] text-stone-500 max-w-2xl mx-auto leading-relaxed">
          ...
          <div className="w-full">
            <motion.div 
              ...
              viewport={{ once: true }}
              variants={staggerContainer}
              className="max-w-[1000px] mx-auto border-y border-[#EAE0D5] grid grid-cols-1 md:grid-cols-4"
            >
              {/* Row 1 */}
              <motion.div variants={fadeInUp} className="col-span-1 md:col-span-2 border-r-0 md:border-r border-b border-[#EAE0D5] p-14 lg:p-20 flex flex-col justify-center items-center text-center md:items-start md:text-left hover:bg-stone-50/30 transition-colors">
                <span className="text-[3.5rem] lg:text-[4rem] font-serif text-[#3E1C00] mb-2 leading-none">
                  <Counter value="300%" />
                </span>
              ...
              <motion.div variants={fadeInUp} className="col-span-1 md:col-span-2 border-b border-[#EAE0D5] p-14 lg:p-20 flex flex-col justify-center items-center text-center md:items-start md:text-left hover:bg-stone-50/30 transition-colors">
                <span className="text-[3.5rem] lg:text-[4rem] font-serif text-[#3E1C00] mb-2 leading-none">
                  <Counter value="100k+" />
                </span>
              ...
              <motion.div variants={fadeInUp} className="col-span-1 md:col-span-2 border-r-0 md:border-r border-b md:border-b-0 border-[#EAE0D5] p-14 lg:p-20 flex flex-col justify-center items-center text-center md:items-start md:text-left hover:bg-stone-50/30 transition-colors">
                <span className="text-[3.5rem] lg:text-[4rem] font-serif text-[#3E1C00] mb-2 leading-none">
                  <Counter value="250%" />
                </span>
              ...
              <motion.div variants={fadeInUp} className="col-span-1 md:col-span-1 p-12 lg:p-14 flex flex-col justify-center items-center text-center md:items-start md:text-left overflow-hidden hover:bg-stone-50/30 transition-colors">
                <span className="text-[3rem] lg:text-[3.5rem] font-serif text-[#3E1C00] mb-2 leading-none tracking-tight">
                  <Counter value="99.9%" />
                </span>
        ...
        <section className="bg-[#FDFBF7] pt-12 pb-24">
          ...
          >
            ...
            <motion.p variants={fadeInUp} className="text-[19px] text-[#A68B7C] max-w-2xl mx-auto leading-[1.65] font-[400] tracking-[-0.01em]">
        ...
        <section className="bg-[#FDFBF7] pt-24 pb-24 border-t border-[#EAE0D5]">
          ...
          <div className="w-full">
            <motion.div 
              ...
              viewport={{ once: true }}
              variants={staggerContainer}
              className="max-w-[1400px] mx-auto border-y border-[#EAE0D5] grid grid-cols-1 md:grid-cols-2"
            >
              {[
                { icon: <Link className="w-5 h-5 text-white" />, title: "Seamless ERP Integration", desc: "Native integrations with SAP, Oracle, Dynamics 365, AWS, and enterprise ecosystems." },
                { icon: <Brain className="w-5 h-5 text-white" />, title: "Autonomous Decision Intelligence", desc: "AI agents evaluate suppliers, negotiate contracts, and execute decisions automatically." },
                { icon: <BarChart3 className="w-5 h-5 text-white" />, title: "Predictive Spend Analytics", desc: "Surface cost risks, supplier trends, and savings opportunities before they impact operations." },
                { icon: <Shield className="w-5 h-5 text-white" />, title: "Enterprise-Grade Security", desc: "SOC 2 Type II compliant infrastructure with encrypted workflows and role-based access." }
              ].map((benefit, i) => (
                <motion.div 
                  key={benefit.title}
                  variants={fadeInUp}
                  whileHover={{ backgroundColor: "rgba(234, 224, 213, 0.2)" }}
                  className={`p-14 lg:p-20 flex flex-col items-start text-left bg-[#FDFBF7] ${i % 2 === 0 ? 'md:border-r' : ''} ${i < 2 ? 'border-b' : ''} border-[#EAE0D5] transition-colors`}
                >
                  <motion.div 
                    whileHover={{ scale: 1.1, rotate: 5 }}
                    className="w-10 h-10 rounded-lg bg-[#FF5C00] flex items-center justify-center mb-6 shadow-md shadow-orange-500/20"
                  >
                    {benefit.icon}
                  </motion.div>
                  <h3 className="text-[1.75rem] font-serif font-semibold text-[#3E1C00] mb-4 leading-[1.1] tracking-[-0.02em]">{benefit.title}</h3>
                  <p className="text-[16px] text-[#A68B7C] leading-[1.65] pr-4 font-[400]">{benefit.desc}</p>
                </motion.div>
              ))}
            </motion.div>
          </div>
        ...
        <section className="bg-[#FDFBF7] pt-24 pb-24 border-t border-[#EAE0D5]">
          ...
          <div className="w-full">
            ...
            >
              {[
                { step: "01", title: "Connect your enterprise stack", desc: "Integrate SAP, AWS, Microsoft, Oracle, and procurement systems seamlessly.", bg: "#FAF8F3" },
                { step: "02", title: "Let Satori understand your workflows", desc: "AI analyses procurement history, suppliers, contracts, and spend behavior.", bg: "white" },
                { step: "03", title: "Watch autonomous execution begin", desc: "Satori routes approvals, negotiates supplier terms, flags risks, and executes procurement workflows.", bg: "#FAF8F3" }
              ].map((s, i) => (
                <motion.div 
                  key={s.step}
                  variants={fadeInUp}
                ...
                >
                  <div className={`h-[160px] flex items-center justify-center border-b ${i < 2 ? 'md:border-r' : ''} border-[#EAE0D5]`} style={{ backgroundColor: s.bg }}>
                    <motion.div 
                      whileHover={{ scale: 1.05 }}
                      className="bg-white border border-[#EAE0D5]/60 px-6 py-2 shadow-sm text-[11px] font-bold text-[#A68B7C] rounded-sm"
                    >
                      Step {s.step}
                    </motion.div>
                  </div>
                  <div className={`p-10 lg:p-12 flex flex-col items-start text-left flex-1 ${i < 2 ? 'md:border-r' : ''} border-[#EAE0D5]`} style={{ backgroundColor: s.bg }}>
                    <h3 className="text-[1.625rem] font-serif font-semibold text-[#3E1C00] mb-5 leading-[1.1] tracking-[-0.015em]">{s.title}</h3>
                    <p className="text-[16px] text-[#A68B7C] leading-[1.65] font-[400]">{s.desc}</p>
                  </div>
                </motion.div>
              ))}
            </motion.div>
        ...
        <section className="bg-[#FDFBF7] pt-24 pb-24 border-t border-[#EAE0D5]">
          ...
          <div className="w-full">
            <motion.div 
              ...
              viewport={{ once: true }}
              variants={staggerContainer}
              className="max-w-[1400px] mx-auto border-y border-[#EAE0D5] grid grid-cols-2 md:grid-cols-4 bg-[#FDFBF7]"
            >
              {[
                ...
                <motion.div 
                  ...
                  variants={fadeInUp}
                  whileHover={{ backgroundColor: "rgba(234, 224, 213, 0.2)" }}
                  className={`aspect-[2] md:aspect-[2.5] flex items-center justify-center border-[#EAE0D5] ${i < 4 ? 'border-b' : ''} ${(i + 1) % 4 !== 0 ? 'border-r' : ''} transition-colors cursor-default`}
                >
        ...
        <section className="bg-[#FDFBF7] pt-12 pb-24">
          <div className="w-full">
            <motion.div 
              ...
              viewport={{ once: true }}
              variants={staggerContainer}
              className="max-w-[1400px] mx-auto grid grid-cols-1 md:grid-cols-2 gap-0 border-y border-[#EAE0D5] bg-[#FDFBF7]"
            >
              ...
              <div className="p-14 lg:p-20 flex flex-col justify-center border-b md:border-b-0 md:border-r border-[#EAE0D5]">
                ...
                <motion.h2 variants={fadeInUp} className="text-[3rem] lg:text-[3.75rem] font-serif font-semibold text-[#3E1C00] mb-8 tracking-[-0.02em] leading-[1.0] max-w-[520px]">
                  Turn procurement chaos into intelligent orchestration
                </motion.h2>
                <motion.p variants={fadeInUp} className="text-[18px] text-[#A68B7C] leading-[1.65] mb-14 max-w-[580px] font-[400]">
                ...
                <motion.div variants={fadeInUp} className="grid grid-cols-2 gap-8">
                  <div>
                    <div className="text-[3.5rem] font-serif font-semibold text-[#3E1C00] leading-none mb-3 tracking-[-0.02em]">
                      <Counter value="92%" />
                    </div>
              ...
              <motion.div 
                variants={fadeInUp}
                className="bg-[#FFF8F3] flex items-center justify-center p-8 md:p-10 relative overflow-hidden min-h-[400px] border-t md:border-t-0 md:border-l border-[#EAE0D5]"
              >
                <motion.img
                  whileHover={{ scale: 1.02 }}
                  src="/images/satori-workflow.jpg"
                  alt="Satori AI Procurement Workflow Orchestration"
                  className="w-full max-w-[600px] object-contain rounded-xl shadow-2xl shadow-orange-500/10"
                />
              </motion.div>
        ...
        <section className="bg-[#FDFBF7] pt-24 pb-24 border-t border-[#EAE0D5] overflow-hidden">
          ...
          <div className="w-full">
            <motion.div 
              ...
              whileInView={{ opacity: 1, x: 0 }}
              viewport={{ once: true }}
              className="w-full border-y border-[#EAE0D5] bg-[#FDFBF7] flex overflow-x-auto no-scrollbar snap-x snap-mandatory"
            >
              <div className="flex w-max mx-auto px-4 md:px-0">
                {[
                  ...
                  <motion.div 
                    key={i} 
                    whileHover={{ backgroundColor: "rgba(234, 224, 213, 0.1)" }}
                    className="w-[85vw] md:w-[600px] lg:w-[740px] p-14 lg:p-20 border-r border-l md:border-l-0 border-[#EAE0D5] flex flex-col justify-between shrink-0 bg-[#FDFBF7] snap-center transition-colors"
                  >
                    <div>
        ...
        {/* Pricing Section */}
        <section id="pricing" className="bg-[#FDFBF7] py-32 border-t border-[#EAE0D5]">
          <motion.div 
            initial="initial"
            whileInView="whileInView"
            viewport={{ once: true }}
          ...
          >
            <div className="text-center mb-20">
              <motion.div variants={fadeInUp} className="flex items-center justify-center gap-2 mb-6">
                <div className="w-2 h-2 bg-[#FF5C00] rounded-[1px]" />
                <span className="text-[13px] font-semibold text-[#FF5C00] uppercase tracking-[0.14em]">PRICING PLANS</span>
              </motion.div>
              <motion.h2 variants={fadeInUp} className="text-[2.75rem] md:text-[3.5rem] lg:text-[4rem] font-serif font-semibold text-[#3E1C00] mb-8 tracking-[-0.02em] leading-[1.0]">
                Predictable pricing for every scale
              </motion.h2>
              
              <motion.div variants={fadeInUp} className="flex items-center justify-center gap-4 bg-stone-100 p-1 rounded-[6px] w-fit mx-auto">
                <button 
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl mx-auto">
              ...
              <motion.div 
                variants={fadeInUp}
                whileHover={{ y: -8 }}
                className="bg-white p-10 rounded-[8px] border border-[#EAE0D5] flex flex-col h-full shadow-sm"
              >
                <div className="w-8 h-8 rounded bg-stone-50 flex items-center justify-center mb-6 border border-[#EAE0D5]">
                  <div className="w-3 h-3 bg-[#FF5C00] rounded-[2px]" />
                </div>
                <h3 className="text-[1.625rem] font-serif font-semibold text-[#3E1C00] mb-3 leading-[1.1] tracking-[-0.015em]">Starter</h3>
                <p className="text-[14px] text-[#A68B7C] font-[500] mb-8">For small teams getting started.</p>
                ...
                <div className="mb-8 border-b border-[#EAE0D5] pb-8 flex items-baseline gap-1">
                  ...
                  <span className="text-[16px] font-sans font-[500] text-[#A68B7C] tracking-[-0.01em]">/month</span>
                </div>
                
                <div className="flex-1 space-y-4 mb-10">
                  {['Up to 10 users', '5,000 transactions', 'Basic AI insights', 'Email support'].map(feat => (
                ...
                <motion.button 
                  whileTap={{ scale: 0.98 }}
                  className="w-full py-3.5 rounded-[4px] text-[15px] font-[600] tracking-[-0.01em] transition-all bg-[#FF5C00] text-white hover:bg-[#E65200] flex items-center justify-between px-6"
                >
              ...
              <motion.div 
                variants={fadeInUp}
                whileHover={{ y: -8 }}
                className="bg-[#FF5C00] p-10 rounded-[8px] flex flex-col h-full shadow-xl relative overflow-hidden"
              >
                <div className="absolute top-4 right-4 bg-white/20 px-3 py-1 rounded-full text-[10px] font-bold text-white uppercase tracking-wider">Most Popular</div>
                ...
                <div className="flex-1 space-y-4 mb-10">
                  {['Unlimited users', '50,000 transactions', 'Advanced AI workflows', 'Priority support', 'Contract automation'].map(feat => (
                    <div key={feat} className="flex items-center gap-3">
                      <Check className="w-4 h-4 text-[#FF5C00] shrink-0" />
                ...
                <motion.button 
                  whileTap={{ scale: 0.98 }}
                  className="w-full py-3.5 rounded-[4px] text-[15px] font-[600] tracking-[-0.01em] transition-all bg-white text-[#FF5C00] hover:bg-stone-50 flex items-center justify-between px-6"
                >
                  <span>Get Started</span>
                  <ArrowRight className="w-4 h-4" />
                </motion.button>
              ...
              >
                ...
                <p className="text-[14px] text-[#A68B7C] font-[500] mb-8">For global scale operations.</p>
                ...
                <div className="flex-1 space-y-4 mb-10">
                  {['Unlimited everything', 'Custom AI models', 'Dedicated manager', '24/7 Phone support', 'On-prem deployment'].map(feat => (
                    <div key={feat} className="flex items-center gap-3">
                      <Check className="w-4 h-4 text-[#FF5C00] shrink-0" />
                      <span className="text-[15px] text-[#3E1C00] font-[500] tracking-[-0.01em]">{feat}</span>
                    </div>
        ...
        {/* FAQ Section */}
        <section className="bg-[#FDFBF7] py-32 border-t border-[#EAE0D5]">
          <div className="max-w-7xl mx-auto px-4">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
              ...
              >
                ...
                <motion.h2 variants={fadeInUp} className="text-[2.75rem] md:text-[3.5rem] lg:text-[4.25rem] font-serif font-semibold text-[#3E1C00] mb-10 tracking-[-0.02em] leading-[1.0]">
                  Common questions about Satori AI
                </motion.h2>
                <motion.p variants={fadeInUp} className="text-[18px] text-[#A68B7C] leading-[1.65] font-[400] max-w-md">
                  Everything you need to know about implementing next-gen agentic AI in your enterprise.
                </motion.p>
              </motion.div>
              ...
              >
                {[
                  {
                    q: "How does Satori AI learn our workflows?",
                    a: "Satori AI analyzes historical procurement data, existing contracts, and approval cycles to understand your unique business rules."
                  },
                  {
                    q: "Is it compatible with our existing ERP?",
                    a: "Yes, Satori AI integrates seamlessly with SAP, Oracle, NetSuite, and other major enterprise systems via secure APIs."
                  },
                  {
                    q: "How long does implementation take?",
                    a: "Typical enterprise deployments take 4-8 weeks, depending on the complexity of legacy integrations and custom requirements."
                  },
                  {
                    q: "How secure is our enterprise data?",
                    a: "We use enterprise-grade encryption (AES-256), SOC2 compliant data centers, and offer private cloud deployment options."
                  },
                  {
                  ...
                  <motion.div key={idx} variants={fadeInUp} className="border-b border-[#EAE0D5] last:border-b-0">
                    <button 
                    ...
                    >
                      ...
                      <motion.div 
                        ...
                        className={`w-6 h-6 rounded-full flex items-center justify-center shrink-0 transition-colors ${faqOpen === idx ? 'bg-[#3E1C00] text-white' : 'bg-transparent text-[#A68B7C]'}`}>
                        {faqOpen === idx ? (
        ...
        <section className="bg-[#FDFBF7] pt-24 pb-24 border-t border-[#EAE0D5]">
          ...
          <div className="w-full">
            <motion.div 
              ...
              viewport={{ once: true }}
              variants={staggerContainer}
              className="max-w-[1400px] mx-auto border-y border-[#EAE0D5] grid md:grid-cols-3 bg-white"
            >
              {[
                { 
                  tag: "TECHNOLOGY", 
                ...
                <motion.div 
                  key={i} 
                  variants={fadeInUp}
                  className={`flex flex-col border-b md:border-b-0 ${i < 2 ? 'md:border-r' : ''} border-[#EAE0D5] bg-white group cursor-pointer overflow-hidden`}
                >
                  ...
                  <div className="p-8 lg:p-10 flex-1 flex flex-col justify-center">
                    ...
                    <h3 className="text-[1.25rem] font-serif text-[#3E1C00] leading-snug group-hover:text-[#FF5C00] transition-colors">{blog.title}</h3>
                  </div>
                </motion.div>
              ))}
            </motion.div>
        ...
        <div className="max-w-[1400px] mx-auto px-4 relative z-10">
          ...
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between pb-16">
            <motion.h2 
              ...
              whileInView={{ opacity: 1, x: 0 }}
              className="text-[2rem] md:text-[2.25rem] font-serif leading-[1.1] mb-8 md:mb-0 text-white"
            >
            ...
            <motion.div 
              initial={{ opacity: 0, x: 20 }}
              whileInView={{ opacity: 1, x: 0 }}
              className="flex w-full md:w-auto bg-white rounded-[4px] p-1 shadow-sm"
            >
              <input 
                type="email" 
                placeholder="Enter your work email" 
              ...
              <motion.button 
                whileHover={{ scale: 1.02 }}
                whileTap={{ scale: 0.98 }}
                className="px-6 py-3 bg-[#3E1C00] text-white rounded-[2px] text-[12px] font-bold flex items-center gap-4 hover:bg-[#2A1100] transition-colors shrink-0"
              >
                Subscribe
          ...
          <div className="max-w-[1400px] mx-auto px-4 flex flex-col md:flex-row">
            ...
            <div className="md:w-[40%] py-16 pr-12">
              ...
              <div className="flex items-center gap-5">
                {[
                  { icon: <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>, type: 'svg' },
                  { icon: <path d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z"/>, type: 'svg' },
                  { icon: <rect width="20" height="20" x="2" y="2" rx="5" ry="5"/>, type: 'svg_rect' },
                  { icon: <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/>, type: 'svg' }
                ].map((social, i) => (
                  <motion.a 
                    key={i}
                  ...
                  >
                    <svg width="18" height="18" viewBox="0 0 24 24" fill={social.type.includes('rect') ? 'none' : 'currentColor'} stroke={social.type.includes('rect') ? 'currentColor' : 'none'} strokeWidth={social.type.includes('rect') ? "2" : "0"} strokeLinecap="round" strokeLinejoin="round">
                      {social.icon}
                      {social.type === 'svg_rect' && <><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/><line x1="17.5" x2="17.51" y1="6.5" y2="6.5"/></>}
                    </svg>
                  </motion.a>
                ))}
              </div>
            ...
            {/* Links Columns */}
            {[
              { title: "Main Pages", links: ['Home', 'About', 'Features', 'Pricing', 'Blogs', 'Contact'] },
              { title: "Inner Pages", links: ['Careers', 'Case Studies', 'Blog Details'] },
              { title: "Legal", links: ['Privacy Policy', 'Terms & Conditions'] }
            ].map((col, i) => (
              <div key={col.title} className="md:w-[20%] py-16 px-4 md:px-8 md:border-l border-white/20">
                <h4 className="font-serif font-semibold text-[1.5rem] mb-6 text-white tracking-[-0.01em]">{col.title}</h4>
                  ...
                  {col.links.map(link => (
                    <li key={link}>
                      <motion.a 
                        whileHover={{ x: 5 }}
                        href="#" 
                        className="text-[15px] font-[500] text-white hover:text-white/80 transition-all tracking-[-0.01em] inline-block"
                      >
                        {link}
                      </motion.a>
                    </li>
